...
$loader->addPsr4('CarrooiTests\\ConversationsApp\\', __DIR__ . '/../');
...
$config->addConfig(__DIR__. '/../config/config.advanced.neon');
$config->addConfig(FileMock::create('parameters: {databasePath: %appDir%/Model/database_advanced}', 'neon'));
